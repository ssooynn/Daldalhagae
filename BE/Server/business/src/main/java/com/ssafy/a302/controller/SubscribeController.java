...
public class SubscribeController {
	...
	@ApiOperation(value = "구독 추가")
	@PostMapping("")
	public String updateSubInfoAsCanceled(@RequestBody SubscriptionReq subscriptionReq){
		subscriptionServiceImpl.addSubInfo(subscriptionReq);
		return "added";
	}
