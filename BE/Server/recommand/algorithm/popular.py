...
if __name__=='__main__':
    ...
    rank_feed = rank_feed.sort_values(by='mean_rate', ascending=False)['item_sno'].head(10)
    ...
    rank_snack = rank_snack.sort_values(by='mean_rate', ascending=False)['item_sno'].head(10)
    # print(rank_feed.sort_values(by='mean_rate', ascending=False))
    ...
    rank_toy = rank_toy.sort_values(by='mean_rate', ascending=False)['item_sno'].head(10)
    # print(rank_feed.sort_values(by='mean_rate', ascending=False))
