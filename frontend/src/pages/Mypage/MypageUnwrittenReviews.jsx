...
const MypageUnwrittenReviews = () => {
  const [subscriptionList, setSubscriptionList] = useState([{
    ...
    subscriptionsName: 'Light All In One Package',
    price: 25000,
    items : [{
                sno : '(String)',
                name : '(String)',
    ...
    {subscriptionList ? 
      subscriptionList.map((subscription, idx)=>{
        return(
          // 구독 리스트 아이템 컴포넌트
          <div id={idx}>
            <SubscriptionItem page='subsNow' bgImg={subscription.subscriptionsName.replaceAll(' ','')} subscription={subscription} reviewConnect={true} isDetail={false}></SubscriptionItem>
          </div>
