  ...
  return (
    <SignupBox>
      ...
      <FlexBox direction="column" align="flex-start" width="auto">
        <StyledText size="14px" style={{ display: "inline" }}>
          쇼핑몰 이용약관
        </StyledText>
        <DetailText>
          <StyledText size="12px" weight="300">
            제1조(목적)
            <br />이 약관은 연준주식회사(전자상거래 사업자)가 운영하는
            '달달하개'에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를
            ...
            제2조(정의)
            <br />
            <br /> ① “몰”이란 OO 회사가 재화 또는 용역(이하 “재화 등”이라 함)을
      ...
      <FlexBox direction="column" align="flex-start" width="auto">
        ...
        <DetailText>
          <StyledText size="12px" weight="300">
            ...
            <br />
            <br />
            '달달하개'은(는) 다음의 목적을 위하여 개인정보를 처리합니다.
            ...
            <br />
            <br />
            ①'달달하개'은(는) 법령에 따른 개인정보 보유·이용기간 또는
            ...
            <br />
            <br />
            재화 또는 서비스 제공와 관련한 개인정보는 수집.이용에 관한
            동의일로부터 1년까지 위 이용목적을 위하여 보유.이용됩니다.
            <br />
            <br />
            보유근거 : 본 앱 사용으로 인한 개인정보를 별도로 수집 및 보관하지
            않습니다.
            <br />
            <br />
            관련법령 :
            ...
            <br />
            <br />① 정보주체는 텍스트박스에 대해 언제든지 개인정보
            열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
            <br />
            <br />② 제1항에 따른 권리 행사는텍스트박스에 대해 「개인정보
            보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX)
            등을 통하여 하실 수 있으며 텍스트박스은(는) 이에 대해 지체 없이
            조치하겠습니다.
            <br />
            ...
            <br />
            <br />⑥ 텍스트박스은(는) 정보주체 권리에 따른 열람의 요구,
            ...
            <br />
            <br />① '달달하개'은(는) 다음의 개인정보 항목을 처리하고 있습니다.
            <br />
            <br />1
            <br />
            <br />
            ...
            제5조(개인정보의 파기)
            <br />
            <br />① '달달하개'은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
            ...
            <br />
            <br />
            2. 보존하는 개인정보 항목 : 별도 보존하는 개인정보 항목이 없습니다.
            <br />
            ...
            <br />
            <br />
            '달달하개'은(는) 파기 사유가 발생한 개인정보를 선정하고, '달달하개'
            의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
            <br />
            <br />
            2. 파기방법
            <br />
            <br />앱 사용자의 사용정보를 수집 및 보유하지 않습니다. 따라서 파기
            해야 하는 개인정보를 가지고 있지 않습니다.
            <br />
            <br />
            <br />
            제6조(개인정보의 안전성 확보 조치)
            <br />
            <br />
            '달달하개'은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를
            취하고 있습니다.
            <br />
            <br />
            ...
            <br />
            <br />
            텍스트박스 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
            ...
            <br />
            <br />
            연락처 :010-8548-8104, help.textbox@gmail.com,
            <br />
      ...
      <FlexBox direction="column" align="flex-start" width="auto">
        ...
        <DetailText>
          <StyledText size="12px" weight="300">
            ...
            <br />
            <br />
            사용자(이하 “위탁자”이라 한다)과 달달하개(이하 “수탁자”이라 한다)는
            “위탁자”의 개인정보 처리업무를 “수탁자”에게 위탁함에 있어 다음과
            같은 내용으로 본 업무위탁계약을 체결한다.
            <br />
            <br />
            <br />
            <br />
            제1조 (목적) 이 계약은 “위탁자”가 개인정보처리업무를 “수탁자”에게
            위탁하고, “수탁자”는 이를 승낙하여 “수탁자”의 책임아래 성실하게
            업무를 완성하도록 하는데 필요한 사항을 정함을 목적으로 한다.
            <br />
            <br />
            <br />
            <br />
            제2조 (용어의 정의) 본 계약에서 별도로 정의되지 아니한
            용어는「개인정보 보호법」, 같은 법 시행령 및 고시,「개인정보의
            안전성 확보조치 기준」(개인정보보호위원회 고시 제2021-2호) 및「표준
            개인정보 보호지침」(개인정보보호위원회 고시 제2020-1호)에서 정의된
            바에 따른다.
            <br />
            <br />
            <br />
            ...
            개인 목적으로 다음과 같은 개인정보 처리 업무를 수행한다. 각호의 업무
            예시 : 고객만족도 조사 업무, 회원가입 및 운영 업무, 사은품 배송을
            위한 이름, 주소, 연락처 처리 등
            <br />
            <br />
            <br />
            <br />
            제4조 (위탁업무 기간) 이 계약서에 의한 개인정보 처리업무의 기간은
            다음과 같다.
            <br />
            <br />
            <br />
            <br />
            제5조 (재위탁 제한) ① “수탁자”는 “위탁자”의 사전 승낙을 얻은 경우를
            제외하고 “위탁자”와의 계약상의 권리와 의무의 전부 또는 일부를
            제3자에게 양도하거나 재위탁할 수 없다.
            <br />
            <br />② “수탁자”가 다른 제3의 회사와 수탁계약을 할 경우에는
            “수탁자”는 해당 사실을 계약 체결 7일 이전에 “위탁자”에게 통보하고
            협의하여야 한다.
            <br />
            <br />
            <br />
            <br />
            제6조 (개인정보의 안전성 확보조치) “수탁자”는「개인정보
            보호법」제23조제2항 및 제24조제3항 및 제29조, 같은 법 시행령 제21조
            및 제30조, 「개인정보의 안전성 확보조치 기준」(개인정보보호위원회
            고시 제2021-2호)에 따라 개인정보의 안전성 확보에 필요한
            관리적․기술적 조치를 취하여야 한다.
            <br />
            <br />
            <br />
            <br />
            제7조 (개인정보의 처리제한) ① “수탁자”는 계약기간은 물론 계약 종료
            후에도 위탁업무 수행 목적 범위를 넘어 개인정보를 이용하거나 이를
            제3자에게 제공 또는 누설하여서는 안 된다.
            <br />
            <br />② “수탁자”는 계약이 해지되거나 또는 계약기간이 만료된 경우
            위탁업무와 관련하여 보유하고 있는 개인정보를 「개인정보
            보호법」시행령 제16조 및「개인정보의 안전성 확보조치
            기준」(개인정보보호위원회 고시 제2021-2호)에 따라 즉시 파기하거나
            “위탁자”에게 반납하여야 한다.
            <br />
            <br />③ 제2항에 따라 “수탁자”가 개인정보를 파기한 경우 지체없이
            “위탁자”에게 그 결과를 통보하여야 한다.
            <br />
            <br />
            <br />
            <br />
            제8조 (수탁자에 대한 관리·감독 등) ① “위탁자”는 “수탁자”에 대하여
            다음 각 호의 사항을 감독할 수 있으며, “수탁자”는 특별한 사유가 없는
            한 이에 응하여야 한다.
            <br />
            <br />
            1. 개인정보의 처리 현황
            ...
            <br />
            <br />
            4. 목적외 이용․제공 및 재위탁 금지 준수여부5. 암호화 등 안전성
            확보조치 이행여부6. 그 밖에 개인정보의 보호를 위하여 필요한 사항
            <br />
            <br />② “위탁자”는 “수탁자”에 대하여 제1항 각 호의 사항에 대한
            실태를 점검하여 시정을 요구할 수 있으며, “수탁자”는 특별한 사유가
            없는 한 이행하여야 한다.
            <br />
            <br />③ “위탁자”는 처리위탁으로 인하여 정보주체의 개인정보가
            분실·도난·유출·변조 또는 훼손되지 아니하도록 1년에 ( )회 “수탁자”를
            교육할 수 있으며, “수탁자”는 이에 응하여야 한다. 「개인정보 안전성
            확보조치 기준 고시」(개인정보보호위원회 고시 제2021-2호) 및
            「개인정보 보호법」 제26조에 따라 개인정보처리자 및 취급자는
            개인정보보호에 관한 교육을 의무적으로 시행하여야 한다.
            <br />
            <br /> 제1항에 따른 교육의 시기와 방법 등에 대해서는 “위탁자”는
            “수탁자”와 협의하여 시행한다.
            <br />
            <br />
            <br />
            <br />
            제9조 (정보주체 권리보장) ① “수탁자”는 정보주체의 개인정보 열람,
            정정·삭제, 처리 정지 요청 등에 대응하기 위한 연락처 등 민원 창구를
            마련해야 한다.
            <br />
            <br />
            <br />
            <br />
            제10조 (개인정보의 파기) ① “수탁자”는 제4조의 위탁업무기간이
            종료되면 특별한 사유가 없는 한 지체 없이 개인정보를 파기하고 이를
            “위탁자”에게 확인받아야 한다.
            <br />
            <br />
            <br />
            <br />
            제11조 (손해배상) ① “수탁자” 또는 “수탁자”의 임직원 기타 “수탁자”의
            수탁자가 이 계약에 의하여 위탁 또는 재위탁 받은 업무를 수행함에 있어
            이 계약에 따른 의무를 위반하거나 “수탁자” 또는 “수탁자”의 임직원
            기타 “수탁자”의 수탁자의 귀책사유로 인하여 이 계약이 해지되어
            “위탁자” 또는 개인정보주체 기타 제3자에게 손해가 발생한 경우
            “수탁자”는 그 손해를 배상하여야 한다.
            <br />
            <br />② 제1항과 관련하여 개인정보주체 기타 제3자에게 발생한 손해에
            대하여 “위탁자”가 전부 또는 일부를 배상한 때에는 “위탁자”는 이를
            “수탁자”에게 구상할 수 있다.
            <br />
            <br />
            <br />
            <br />본 계약의 내용을 증명하기 위하여 계약서 2부를 작성하고,
            “위탁자”와 “수탁자”가 서명 또는 날인한 후 각 1부씩 보관한다.
          </StyledText>
        </DetailText>
        <div style={{ alignSelf: "flex-end" }}>
          <input
      ...
      <FlexBox direction="column" align="center" width="auto">
        <div style={{ justifySelf: "flex-end" }}>
          ...
          />
          <label for="전체동의">
            <StyledText size="14px" weight="500" style={{ display: "inline" }}>
              전체 동의합니다
            </StyledText>{" "}
          </label>
        </div>
